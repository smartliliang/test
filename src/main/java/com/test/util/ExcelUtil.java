...
public class ExcelUtil {
    ...
    public static XSSFWorkbook createExcelFile(Class clazz, List objs, Map<Integer, List<ExcelBean>> map, String sheetName) throws
            ...
            ClassNotFoundException, IntrospectionException, ParseException, java.beans.IntrospectionException, UnsupportedEncodingException {
        // 创建新的Excel工作簿
    ...
    public static void createTableRows(XSSFSheet sheet, Map<Integer, List<ExcelBean>> map, List objs, Class clazz)
            throws UnsupportedEncodingException, ClassNotFoundException, IntrospectionException, IllegalAccessException, ParseException, InvocationTargetException, IntrospectionException, java.beans.IntrospectionException {
